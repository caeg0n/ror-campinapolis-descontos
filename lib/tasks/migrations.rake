...
task :migrations do
  ...
  FileUtils.cp("#{project_path}/app/models/promo.rb", "#{project_path}/app/models/backup") if File.exist?("#{project_path}/app/models/promo.rb")
  ...
  #h('rails d scaffold product_category')
  ...
  sh('rails g scaffold promo organization:references coupon_price:decimal expiration:datetime status:integer')
  sh('rails g scaffold coupon_product promo:references product:references coupon_type:integer status:integer')
  sh('rails g scaffold coupon_sale promo:references coupon_type:integer status:integer')
