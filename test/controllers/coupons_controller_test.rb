...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference("Coupon.count") do
      post coupons_url, params: { coupon: { coupon_type: @coupon.coupon_type, expiration: @coupon.expiration, product_id: @coupon.product_id, status: @coupon.status, value: @coupon.value } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { coupon_type: @coupon.coupon_type, expiration: @coupon.expiration, product_id: @coupon.product_id, status: @coupon.status, value: @coupon.value } }
