...
class PromosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promo" do
    assert_difference("Promo.count") do
      post promos_url, params: { promo: { coupon_price: @promo.coupon_price, expiration: @promo.expiration, organization_id: @promo.organization_id, status: @promo.status } }
    end
  ...
  test "should update promo" do
    patch promo_url(@promo), params: { promo: { coupon_price: @promo.coupon_price, expiration: @promo.expiration, organization_id: @promo.organization_id, status: @promo.status } }
